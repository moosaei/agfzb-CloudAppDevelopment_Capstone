...
def analyze_review_sentiments(review_text):
    ...
    url = os.environ['https://api.eu-gb.natural-language-understanding.watson.cloud.ibm.com/instances/67b4cd0e-3598-4f19-91e2-bd4c38caff3b']
    api_key = os.environ["zkW07PhImEQgbzqyiIByVbNctVkdYdk-sJdaJhG-dTAK"]
    version = '2020-08-01'
